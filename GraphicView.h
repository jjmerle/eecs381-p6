...
private:
    ...
    virtual const char* const get_empty_space() { return empty_map_space_c; }
    // Get space with multiple ships from derived class
    virtual const char* const get_crowded_space() { return crowded_map_space_c; }
    // Get the second dimension of the map
    virtual int get_second_dimension_size() { return size; }
};
